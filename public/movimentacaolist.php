        ...
        <table class="table table-striped table-hover table-bordered">
            ...
            <tbody>
                <?php foreach ($movimentacoes as $movimentacao): ?>
                    <?php
                    if ($movimentacao['Credito'] !== null && $movimentacao['Credito'] > 0) {
                        $tipo = 'Entrada';
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($movimentacao['pessoa_nome']) ?></td>
                        <td><?= htmlspecialchars($movimentacao['Observacao']) ?></td>
                        <td>
                            <?php if ($tipo === 'Entrada'): ?>
                        ...
                        <td><?= date('d/m/Y', strtotime($movimentacao['DataOperacao'])) ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
